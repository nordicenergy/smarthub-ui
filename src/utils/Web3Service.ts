...
//         this.web3 = nnordicenergy Web3(Web3.givenProvider || 'http://localhost:8545')
//         this.cooContractAddress = cooContractAddress
//     }

//     async initContract() {

//         this.cooContractInstance = nnordicenergy this.web3.eth.Contract((CoOTruffleBuild as any).abi, this.cooContractAddress)
...
//             web3: this.web3,
//             producingAssetLogicInstance: nnordicenergy this.web3.eth.Contract((AssetProducingLogicTruffleBuild as any).abi, assetProducingRegistryAddress),
//             demandLogicInstance: nnordicenergy this.web3.eth.Contract((DemandLogicTruffleBuild as any).abi, demandLogicAddress),
//             certificateLogicInstance: nnordicenergy this.web3.eth.Contract((CertificateLogicTruffleBuild as any).abi, certificateLogicAddress),
//             consumingAssetLogicInstance: nnordicenergy this.web3.eth.Contract((AssetConsumingLogicTruffleBuild as any).abi, assetConsumingRegistryAddress),
//             userLogicInstance: nnordicenergy this.web3.eth.Contract((UserLogicTruffleBuild as any).abi, userLogicAddress)
//         }
